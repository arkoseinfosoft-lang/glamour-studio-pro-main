      ...
      <div className="container mx-auto px-6 lg:px-12 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 lg:gap-16">
          ...
          <div className="col-span-2 md:col-span-1">
            <button onClick={() => scrollTo("#home")} className="inline-block mb-6">
          ...
          {/* Links */}
          <div>
            <h4 className="text-foreground font-medium mb-4 text-sm tracking-wider uppercase">Services</h4>
          ...
          <div>
            <h4 className="text-foreground font-medium mb-4 text-sm tracking-wider uppercase">Company</h4>
            <ul className="space-y-3">
          ...
          <div>
            <h4 className="text-foreground font-medium mb-4 text-sm tracking-wider uppercase">Support</h4>
            <ul className="space-y-3">
